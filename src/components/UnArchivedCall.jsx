      ...
      <ul
        ...
        {list.map(
          (contact, i) =>
            contact?.to &&
            contact.from && (
              <li key={contact?.id} className="chat-item ccc" style={{ paddingBottom: '8px', border: '1px solid #dfdfdf', borderRadius: '10px', margin: '20px 20px 10px 5px', padding: '15px 15px 15px 15px' }} onClick={() => toggleArchive(i)} >
                <div className="call">
